...
import static BasicThinking.Lesson1_1.decimalToBinary;
...
public class Lesson1_3 {
    public static void main(String[] args) {
        ...
        System.out.println(String.format(" 数字 %d(%s) 和数字 %d(%s) 的按位‘异或’结果是 %d(%s)",
                a, decimalToBinary(a), b, decimalToBinary(b), Lesson1_3.xor(a, b), decimalToBinary(Lesson1_3.xor(a, b))));  // 获取十进制数 53 和 35 的按位“异或”
